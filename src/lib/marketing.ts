// Shared marketing copy, reused across the About page, onboarding intro, and the
// public quick-share page so the story stays consistent in one place.

export const ONE_LINER =
  "Refr is a talent-sharing network for fellowships, programs, and hiring orgs.";
...
export const TAGLINE_B = "Talent has better discoverability.";
...
export const VALUE_POINTS: { title: string; blurb: string }[] = [
  ...
  },
  {
    ...
    blurb: "Describe who you're looking for in plain language and get a constant sourcing pipeline across the network.",
  },
  {
    title: "Share securely, with consent",
    blurb: "No more emailing spreadsheets. Only applicants who opted in ever cross an org boundary.",
  },
];
